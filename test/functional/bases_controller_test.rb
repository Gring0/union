...
class BasesControllerTest < ActionController::TestCase
  ...
  test "should create basis" do
    assert_difference('Basis.count') do
      post :create, basis: { description: @basis.description, enabled: @basis.enabled, name: @basis.name }
    end
  ...
  test "should update basis" do
    put :update, id: @basis, basis: { description: @basis.description, enabled: @basis.enabled, name: @basis.name }
    assert_redirected_to basis_path(assigns(:basis))
  end
