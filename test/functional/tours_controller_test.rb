...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { enabled: @tour.enabled, enddate: @tour.enddate, name: @tour.name, startdate: @tour.startdate, type: @tour.type }
    end
  ...
  test "should update tour" do
    put :update, id: @tour, tour: { enabled: @tour.enabled, enddate: @tour.enddate, name: @tour.name, startdate: @tour.startdate, type: @tour.type }
    assert_redirected_to tour_path(assigns(:tour))
  end
